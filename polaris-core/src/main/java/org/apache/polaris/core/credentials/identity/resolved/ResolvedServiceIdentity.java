 ...
 * under the License.
 */
package org.apache.polaris.core.credentials.identity.resolved;

import jakarta.annotation.Nonnull;
import org.apache.polaris.core.credentials.identity.ServiceIdentityType;
import org.apache.polaris.core.credentials.identity.dpo.ServiceIdentityInfoDpo;
...
public abstract class ResolvedServiceIdentity {
  ...
  private final String identityInfoReference;

  public ResolvedServiceIdentity(ServiceIdentityType identityType) {
    this(identityType, null);
  }

  public ResolvedServiceIdentity(ServiceIdentityType identityType, String identityInfoReference) {
  ...
  public String getIdentityInfoReference() {
