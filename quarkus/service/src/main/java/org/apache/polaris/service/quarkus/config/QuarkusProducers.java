...
import org.apache.polaris.service.credentials.ServiceIdentityConfiguration;
...
public class QuarkusProducers {
  ...
  public PolarisCallContext polarisCallContext(
    ...
    return new PolarisCallContext(
        metaStoreSession, diagServices, configurationStore, entityMutationEngine, clock);
  }
  ...
  @Produces
  @RequestScoped
  public PolarisCredentialManager polarisMetaStoreManager(
